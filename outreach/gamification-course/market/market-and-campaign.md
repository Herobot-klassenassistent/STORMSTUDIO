...
## Market 1 · Erasmus+ KA1 (best fit)

**Proof it pays.** EU teachers get 100% funding to attend PD abroad; providers
charge a course fee per participant per week (commonly around €400-500, sometimes
bundled higher with accommodation). Providers such as Europass Teacher Academy run
450+ courses; the demand is structural and recurring.
([erasmustrainingcourses.com](https://erasmustrainingcourses.com/) ·
[teacheracademy.eu](https://www.teacheracademy.eu/))
...
## Market 2 · Dutch funded in-school PD

**Proof it pays.** Schools already buy study days and professionalisering from
external experts, funded by CmK (Cultuureducatie met Kwaliteit), and from the
structural basisvaardigheden money that explicitly covers **digitale
geletterdheid** (structural for every school from 2027). Kevin already has live,
warm leads here (SWV's, Agora schools, Cultuur Oost, OOE team-training).

**How to enter.** Sell the flagship or a subsection as a study-day package to the
schools, boards and SWV's already in the outreach pipeline. The materials make one
trainer look like a whole institute.

**Price.** €2,400-3,600 per group for a live day/two-day; or a school licence
(€549 full / €249 subsection) for self-run use. **Verdict:** strong, already in
motion, sell it into the existing campaign.

## Market 3 · Self-hosted course sales

**Proof it pays.** The online-course market is mature; the winning move for an
expert with an audience is to **self-host** (Teachable/Thinkific/Plug&Pay/Copecart
or a simple Gumroad/Payhip checkout) and keep the margin, using marketplaces only
for discovery.
([learnworlds.com guide](https://www.learnworlds.com/how-to-sell-online-courses/))

**How to enter.** Put the download on kevinstorm.eu/curriculum with a checkout.
Start with one price, add the bundle and school licence, then a subscription or
cohort later.

**Price.** €149 full / €59 subsection / €199 bundle (self-paced). **Verdict:**
best margin and it compounds; build the page now, it underpins everything.
...
[income breakdown](https://seolumina.com/blog/how-much-do-tpt-sellers-make-in-2026-real-data-income-breakdown))

**How to use it.** Not as the main income. List a few small, cheap resources
(a "6 levers" poster, an AI-prompt pack, a Delightex starter brief) that are
useful alone **and** advertise the full course. It is a discovery and credibility
channel that points back to kevinstorm.eu.

**Price.** €3-12 per resource. **Verdict:** lead-gen and proof, low effort, do
...
### Phase 1 (weeks 1-3) · Build the shopfront
- Publish the expanded **kevinstorm.eu/curriculum** section (design supplied).
- Set up a simple checkout (Gumroad/Payhip/Plug&Pay) for the download products.
- Ship the free lead magnet and start collecting emails.
- Finish the branded PDFs (done) and record a 2-minute intro video.
...
### Phase 4 (weeks 10-13) · Scale what works
- Double down on the channel that sold: providers, schools, or direct.
- Add the bundle and school-licence offers prominently.
- Plan the online 4×half-day cohort as a recurring, low-effort revenue line.

## KPIs to watch

- Emails collected (lead magnet).
- First-sale conversion (tripwire).
- Provider/school conversations booked and closed.
- Revenue by market (so you know where to lean).

## First five actions (do these first)

1. Publish the kevinstorm.eu/curriculum expansion (HTML supplied).
2. Put the full course + subsections on a checkout link.
3. Email GEC Academy offering the 2026 course for their catalogue.
