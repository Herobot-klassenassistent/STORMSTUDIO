# Campagne — Bijzondere scholen (buiten het standaardonderwijs)

Scholen die niet in het reguliere plaatje passen: speciaal onderwijs / complexe
zorg, hoogbegaafdenonderwijs, justitiele jeugdinrichtingen, democratisch en
zelfsturend onderwijs. Doel: workshops/lessen, lesmateriaal en curriculum op
maat, en teamtrainingen. Allemaal nog niet eerder benaderd.

Mail = Kevins eigen warme intro (zie `subsidiepartners-cmk/mails/01-cmk-coordinator.md`
voor de basis), per school gepersonaliseerd. Volgt `../SCHRIJFREGELS.md`:
geen em dashes, geen AI-markers, schone HTML-links.

## Concepten klaar in Gmail (9, geverifieerde adressen)
1. **De Berkenschutse** (Heeze) — informatie@berkenschutse.nl — expertisecentrum (V)SO.
2. **Portalis / VSO Veenhuizen** (JJI) — d.schroor@elker.nl — justitiele jeugd; persoonlijk aan teamleider Dewi Schroor. REGIO (Drenthe).
3. **Wings Agora** (Roermond) — info@wingsroermond.nl — Agora/zelfsturend onderwijs.
4. **De Twijn** (Zwolle) — regionaalexpertiseteam@detwijn.nl — mytyl/tyltyl/revalidatie SO. REGIO.
5. **De Achtbaan** (Utrecht) — info.deachtbaan@ksu.nl — voltijd hoogbegaafdenonderwijs.
6. **Democratische school De Ruimte** (Soest) — info@deruimtesoest.nl — democratisch onderwijs.
...
en meer cluster 3/4-scholen buiten de al benaderde (let op: Attendiz en de
SO-shortlist zijn al eerder benaderd). Woodbrookers gesloten sinds 2024.
